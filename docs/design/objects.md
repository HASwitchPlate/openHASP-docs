...
| tag         | :material-new-box:{ .tag-small } | [JSONobject][11] | no       | n/a     | Arbitrary attribute data. Once set, it will be returned along with each event. For advanced scenarios (more info in an [example][17]).
