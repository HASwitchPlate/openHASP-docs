...
<div class="row justify-content-center">
        <a href="../images/wt32-sc01-front.png" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-6" data-title="WT32-SC01 Front" data-footer="">
            <img src="../images/wt32-sc01-front.png" class="img-fluid">
        </a>

        <a href="../images/wt32-sc01-back.png" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-6" data-title="WT32-SC01 Back" data-footer="">
            <img src="../images/wt32-sc01-back.png" class="img-fluid">
        </a>
</div>
...
<div class="row justify-content-center">
    <a href="../images/wt32-sc01-1.jpg" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-4" data-title="Wireless-Tag WT32-SC01" data-footer="Image by xHirschx">
        <img src="../images/wt32-sc01-1.jpg" class="img-fluid">
    </a>
    <a href="../images/wt32-sc01-2.jpg" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-4" data-title="Wireless-Tag WT32-SC01" data-footer="Image by xHirschx">
        <img src="../images/wt32-sc01-2.jpg" class="img-fluid">
    </a>
    <a href="../images/wt32-sc01-3.jpg" data-toggle="lightbox" data-gallery="example-gallery" class="col-sm-4" data-title="Wireless-Tag WT32-SC01">
        <img src="../images/wt32-sc01-3.jpg" class="img-fluid">
    </a>
</div>
